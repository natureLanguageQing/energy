...
def doSpider(keyword, sort_by='focus', export_path=""):
    ...
    if not os.path.exists(fileName):
        with open(os.path.join(export_path, fileName), 'a+', encoding='utf-8-sig', newline='') as f:
            writer = csv.writer(f)
...
if __name__ == "__main__":
    company_list = open("../c_data/央企列表", "r", encoding="utf8").readlines()
