...
if __name__ == "__main__":
    ...
    company_list = pd.read_excel("../c_data/查企业_科技_企查查(50666285).xls").values.tolist()
    ...
    for company_one in company_list:
        print(company_one[0] + " " + company_one[2])
        # ps.apply(worker,args=(i,))     # 同步执行
        ps.apply_async(doSpider, args=(
            company_one[0] + " " + company_one[2],
            'focus',
            '../data/baidu_news/company_person'))  # 异步执行
